...
export function SignIn() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-4rem)] bg-neutral-950 font-mono">
      {/* Left split: Brand Panel in #1D4ED8 */}
        ...
        <Card className="w-full max-w-md bg-neutral-900 border-neutral-800 text-white p-2">
          <CardHeader className="space-y-1">
            <div className="flex items-center justify-between">
              <CardTitle className="text-2xl font-bold tracking-tight text-white">Login to your account</CardTitle>
              <Link to="/signup" className="text-xs text-neutral-400 hover:text-white transition-colors">Sign Up</Link>
            </div>
            ...
            <form onSubmit={signin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-neutral-400 hover:text-white hover:underline">
